...
import { CalendarStoreType } from 'src/types/calendarTypes'
...
export const insuranceAtom = atom<CalendarStoreType>({
  key: 'calendarAtom',
  default: selector({
    key: 'calendarLoader',
    get: async ({ get }) => {
      ...
      console.log('insurance load')
      const storedToken = window.localStorage.getItem('accessToken')!
      // let response = await server.get(API.insurances, {
      //   headers: {
      //     Authorization: `Bearer ${storedToken}`
      //   }
      // })
      //   if (response.data) {
      //     console.log('insurance return ', response.data)
