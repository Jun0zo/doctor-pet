...
// ** Types Imports
import { DateType } from 'src/types/jobTypes'
import { AttendanceProps } from 'src/types/attendanceTypes'
...
interface Props {
  selectedStates: AttendanceProps
...
const AddCard = (props: Props) => {
  // ** Props
  let { kind, selectedStates, userList, me } = props

  // ** States
  const [selectedStartDate, setSelectedStartDate] = selectedStates.startDate
  const [selectedEndDate, setSelectedEndDate] = selectedStates.endDate
  ...
  const handleStartDateChange = (date: any, keyboardInputValue?: string | undefined) => {
    console.log(date.$d)
    if (true) {
      // Nan check
  ...
  const handleEndDateChange = (date: any, keyboardInputValue?: string | undefined) => {
    console.log(date.$d)
    if (true) {
                  ...
                  >
                    <Box sx={{ mb: 4, display: 'flex', alignItems: 'center' }}>
                      <DatePicker
                        ...
                        customInput={<CustomInput date={selectedStartDate} />}
                  ...
                  >
                    <Box sx={{ mb: 4, display: 'flex', alignItems: 'center' }}>
                      <DatePicker
                        ...
                        customInput={<CustomInput date={selectedEndDate} />}
