...
def parse_args():
    ...
    parser.add_argument('--save_folder', default='weights2/', type=str, 
    ...
    parser.add_argument('--topk', default=100, type=int,
                        help='NMS threshold')
    parser.add_argument('-p', '--coco_pretrained', default='pretrained/yolof-rt_r50_DC5_1x_38.1.pth', type=str,#
